    ...
    <div className="pt-20 space-y-6">
      ...
      <div className="flex gap-4 justify-center">
        ...
        <button
          ...
          className={`${isAutoExploring ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700'} px-6 py-2 rounded-lg text-lg font-semibold shadow-md`}
        >
          {isAutoExploring ? 'Stop Exploring' : 'Start Exploring'}
        </button>
        <button 
          onClick={onBloodRite}
